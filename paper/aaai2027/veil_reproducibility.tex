...
\begin{itemize}
	...
	\question{If an algorithm depends on randomness, then its randomness controls are described in a way sufficient to allow replication of results}{(yes/partial/no/NA)}
	yes
